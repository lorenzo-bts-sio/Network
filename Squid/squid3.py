...
auth_param basic program /usr/lib/squid/ncsa_auth /etc/squid/utilisateurs # On déclare le programme qui gère l'authentification 
auth_param basic program children 10
auth_param basic program realm connectez-vous au serveur proxy
auth_param basic program credentialsttl 2hours
auth_param basic program casesensitive off 
